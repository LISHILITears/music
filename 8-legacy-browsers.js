...
function Second_Welcome_ScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    Second_Welcome_ScreenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trials_soundsLoopBegin(trials_soundsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials_sounds.forEach(function() {
...
function musicalpreference_popRoutineBegin(snapshot) {
  return async function () {
    ...
    musicalpreference_popComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function musicalpreference_classicRoutineBegin(snapshot) {
  return async function () {
    ...
    musicalpreference_classicComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function musicalpreference_heavymetalRoutineBegin(snapshot) {
  return async function () {
    ...
    musicalpreference_heavymetalComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
